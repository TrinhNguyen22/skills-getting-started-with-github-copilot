...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball techniques and play in after-school scrimmages",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific discoveries together",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "mason@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for debates and develop public speaking and critical thinking skills",
